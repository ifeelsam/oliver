            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">$340k value pending</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">APY across 3 pools</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium">Cross-Chain</CardTitle>
                        <Activity className="h-4 w-4 text-muted-foreground" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold">5 Chains</div>
                        <p className="text-xs text-muted-foreground">Circle Arc Enabled</p>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                <Card className="col-span-4">
                    <CardHeader>
                        ...
                        <CardDescription>Treasury performance across networks</CardDescription>
                    </CardHeader>
                ...
                <Card className="col-span-3">
                    <CardHeader>
                        ...
                        <CardDescription>Latest invoices and settlements</CardDescription>
                    </CardHeader>
                    <CardContent>
